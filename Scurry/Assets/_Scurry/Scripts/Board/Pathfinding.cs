...
namespace Scurry.Board
{
    public static class Pathfinding
    {
        ...
        public static List<Vector2Int> FindPath(Tile[,] grid, Vector2Int start, Vector2Int goal)
        {
            Debug.Log($"[Pathfinding] FindPath: start={start}, goal={goal}");
